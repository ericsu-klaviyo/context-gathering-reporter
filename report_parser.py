...
\
def parse_report(filepath, summary=False, summary_domain_name=TOTAL_STR, silent=False, suppress=False):
    if not suppress and (not filepath or not os.path.exists(filepath)):
...
if __name__ == "__main__":
    ...
    if args.date and not args.silent:
        print(f"{args.date}\n")
    parse_report(args.filepath, summary=args.summary)
